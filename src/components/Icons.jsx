...
const createIcon = (paths) => {
  return ({ size = 18, color = 'currentColor', className = '', ...props }) => (
    <svg
...
export const ResumeIcon = createIcon(
  <>
...
export const GenderIcon = createIcon(
  <>
    ...
    <path d="M12 13v8M9 18h6M15 5l3 3M18 5v3" />
  </>
);

export const MaritalIcon = createIcon(
  <>
...
export const NationalityIcon = createIcon(
  <>
...
export const CheckInIcon = createIcon(
  <>
...
export const CheckOutIcon = createIcon(
  <>
...
export const PalmIcon = (props) => (
  <IconWrapper {...props}>
    ...
    <path d="M13 8c0 2.76 2.24 5 5 5s5-2.24 5-5H13z" />
    <path d="M8 8c0 4.42 3.58 8 8 8" />
    <path d="M12 16v5" />
    <path d="M12 21H8" />
  </IconWrapper>
);
